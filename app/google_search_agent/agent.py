...
root_agent = Agent(
    ...
    instruction=(
        ...
        6. When asked about this venue’s details (hours, menu, amenities, payments, kids/pets, policies, specials),
           ...
           Use google_search only for external quick facts (e.g., time) not covered by the knowledge.
        7. Before seating a guest (check_in), confirm with them, then seat. After seating, let them know the table.
        """
    ),
    tools=[
